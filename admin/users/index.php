    ...
    <table class="min-w-full">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-4 py-3 text-left hidden md:table-cell">ইউজারনেম</th>
                <th class="px-4 py-3 text-left hidden md:table-cell">ইমেইল</th>
                <th class="px-4 py-3 text-left hidden md:table-cell">রোল</th>
                <th class="px-4 py-3 text-left">স্ট্যাটাস</th>
                <th class="px-4 py-3 text-left hidden md:table-cell">লাস্ট লগিন</th>
        ...
        <tbody>
            ...
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="px-4 py-2 hidden md:table-cell"><?php echo $user['username']; ?></td>
                ...
                <td class="px-4 py-2 text-sm hidden md:table-cell">
